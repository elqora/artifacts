...
final readonly class VideoArtifactValueSchema
{
    ...
    {
        if (!array_key_exists('valueType', $data)) { throw new InvalidArgumentException('Missing required field valueType for VideoArtifactValueSchema.'); }
