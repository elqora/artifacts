...
final readonly class ImageArtifactValueSchema
{
    ...
    {
        if (!array_key_exists('valueType', $data)) { throw new InvalidArgumentException('Missing required field valueType for ImageArtifactValueSchema.'); }
    ...
    public function requireLocation(): ?bool
    {
        return $this->data['requireLocation'] ?? null;
    }

    public function hasRequireLocation(): bool
    {
        return array_key_exists('requireLocation', $this->data);
    }

    /** @return array<string, mixed> */
    public function unknownFields(): array
    {
        return array_diff_key($this->data, ['minFiles' => true, 'maxFiles' => true, 'acceptedMimeTypes' => true, 'maxSizeBytes' => true, 'valueType' => true, 'requireTimestamp' => true, 'requireLocation' => true]);
    }
