...
final readonly class TimeArtifactValueSchema
{
    ...
    {
        if (!array_key_exists('valueType', $data)) { throw new InvalidArgumentException('Missing required field valueType for TimeArtifactValueSchema.'); }
