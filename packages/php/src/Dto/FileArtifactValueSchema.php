...
final readonly class FileArtifactValueSchema
{
    ...
    {
        if (!array_key_exists('valueType', $data)) { throw new InvalidArgumentException('Missing required field valueType for FileArtifactValueSchema.'); }
    ...
    {
        return array_diff_key($this->data, ['minFiles' => true, 'maxFiles' => true, 'acceptedMimeTypes' => true, 'maxSizeBytes' => true, 'valueType' => true]);
    }
