 ...
 * @phpstan-type ArtifactVersion array{schemaVersion: '1.1', id: non-empty-string, artifactId: non-empty-string, version: positive-int, source: ArtifactSource, integrity?: ArtifactIntegrity, specification?: ArtifactSpecification, createdBy: ActorReference, createdAt: string, note?: string, metadata?: Metadata}
 * @phpstan-type ArtifactLink array{schemaVersion: '1.1', id: non-empty-string, artifactId: non-empty-string, artifactVersionId?: non-empty-string, subject: SubjectReference, role: non-empty-string, note?: string, createdBy: ActorReference, createdAt: string, metadata?: Metadata}
 ...
 * @phpstan-type ArtifactSpec array{schemaVersion: '1.1', id: non-empty-string, key: non-empty-string, name: non-empty-string, description?: string, version: positive-int, kind: non-empty-string, valueType: string, config?: ValueSchema, provider?: ProviderPolicy, requirement?: RequirementPolicy, lifecycle?: LifecyclePolicy, access?: AccessPolicy, privacy?: PrivacyPolicy, validation?: ValidationPolicy, verification?: VerificationPolicy, retention?: RetentionPolicy, presentation?: PresentationPolicy, metadata?: Metadata}
 * @phpstan-type ArtifactSpecSnapshot array{schemaVersion: '1.1', sourceSpecId: non-empty-string, sourceVersion: positive-int, key: non-empty-string, name: non-empty-string, description?: string, kind: non-empty-string, valueType: string, config?: ValueSchema, provider?: ProviderPolicy, requirement?: RequirementPolicy, lifecycle?: LifecyclePolicy, access?: AccessPolicy, privacy?: PrivacyPolicy, validation?: ValidationPolicy, verification?: VerificationPolicy, retention?: RetentionPolicy, presentation?: PresentationPolicy, metadata?: Metadata}
 * @phpstan-type ArtifactRequirement array{schemaVersion: '1.1', id: non-empty-string, key?: non-empty-string, allowedKinds?: list<non-empty-string>, allowedValueTypes?: list<string>, minimumCount?: int<0, max>, maximumCount?: int<0, max>, required: bool, specId?: non-empty-string, metadata?: Metadata}
 * @phpstan-type ArtifactSubmission array{schemaVersion: '1.1', id: non-empty-string, artifactId: non-empty-string, artifactVersionId?: non-empty-string, submittedBy: ActorReference, value?: mixed, submittedAt: string, context?: array{latitude?: float, longitude?: float, deviceId?: non-empty-string, ipAddress?: non-empty-string, userAgent?: string}, metadata?: Metadata}
 * @phpstan-type ArtifactVerification array{schemaVersion: '1.1', id: non-empty-string, artifactId: non-empty-string, artifactVersionId?: non-empty-string, submissionId?: non-empty-string, status: 'pending'|'verified'|'rejected'|'waived', method?: non-empty-string, verifiedBy?: ActorReference, reason?: string, createdAt: string, verifiedAt?: string, metadata?: Metadata}
 */
